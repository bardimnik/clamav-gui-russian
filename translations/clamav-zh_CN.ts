...
<context>
    ...
    <message>
        ...
        <translation>写入标准输出而不是标准错误。不影响&apos;调试&apos;信息。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>在元数据中存储 HTML URI。URI 将被写入 metadata.json 文件的一个名为 &apos;URIs&apos; 的数组中。</translation>
    </message>
    <message>
        <source>Store pdf URIs in metadata. URIs will be written to the metadata.json file in an array called &apos;URIs&apos;.</source>
        <translation>在元数据中存储 PDF URI。URI 将被写入 metadata.json 文件的一个名为 &apos;URIs&apos; 的数组中。</translation>
    </message>
    <message>
        <source>Store md5 and sha1 in addition to sha2-256 in metadata.</source>
        <translation>在元数据中除了存储 sha2-256，还存储 md5 和 sha1。</translation>
    </message>
    <message>
        <source>Only load official signatures.</source>
        <translation>仅加载官方签名。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>移除被感染的文件。请小心！</translation>
    </message>
    <message>
        ...
        <translation>加载未签名的字节码。**警告**：您绝不应该运行来自不可信来源的字节码签名。这样做可能导致任意代码执行。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>转储 PE 文件中的 authenticode 证书链。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>在每个文件扫描后打印文件类型。</translation>
    </message>
    <message>
        ...
        <translation>对用于加密目的的哈希算法实施类似 FIPS 的限制。将禁用 MD5 和 SHA1 的误报签名，并将需要 &apos;.sign&apos; 文件来验证 CVD 的真实性。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>记录有关受感染文件的附加信息，例如其大小和哈希值，以及病毒名称。默认值：no</translation>
    </message>
    <message>
        ...
        <translation>此选项允许您更改默认的临时目录。默认值：系统特定（通常为 /tmp 或 /var/tmp）。</translation>
    </message>
    <message>
        ...
        <translation>此选项允许您更改默认的数据库目录。如果启用它，请确保它在 clamd 和 freshclam 中都指向相同的目录。默认值：在配置时定义（/usr/local/share/clamav）</translation>
    </message>
    <message>
        ...
        <translation>包含用于验证签名数据库存档（例如 CVD 文件）的 ClamAV CA 证书文件的目录路径。此目录必须已存在，为绝对路径，并且可被 freshclam、clamd、clamscan 和 sigtool 读取。默认值：/etc/clamav/certs</translation>
    </message>
    <message>
        ...
        <translation>对用于加密目的的哈希算法实施类似 FIPS 的限制。将禁用 MD5 和 SHA1 的误报签名，并将需要 &apos;.sign&apos; 文件来验证 CVD 的真实性。默认值：no</translation>
    </message>
    <message>
        <source>Only load the official signatures published by the ClamAV project. Default: no</source>
        <translation>仅加载 ClamAV 项目发布的官方签名。默认值：no</translation>
    </message>
    <message>
        ...
        <translation>如果病毒数据库旧于指定的天数，则返回非零错误代码。默认值：-1</translation>
    </message>
    <message>
        <source>Remove stale socket after unclean shutdown. Default: yes</source>
        <translation>在非正常关闭后移除陈旧的套接字。默认值：yes</translation>
    </message>
    <message>
        <source>TCP port number the daemon will listen on. Default: disabled</source>
        <translation>守护进程将监听的 TCP 端口号。默认值：禁用</translation>
    </message>
    <message>
        ...
        <translation>默认情况下，clamd 绑定到 INADDR_ANY。此选项允许您限制 TCP 地址，并提供一定程度的对外部世界的保护。可以多次指定此选项以监听多个 IP。现在支持 IPv6。默认值：禁用</translation>
    </message>
    <message>
        <source>Maximum length the queue of pending connections may grow to. Default: 200</source>
        <translation>挂起连接队列的最大长度。默认值：200</translation>
    </message>
    <message>
        ...
        <translation>当超过数据大小限制时关闭 STREAM 会话。该值应与您的 MTA 的最大附件大小限制相匹配。默认值：100M</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>此选项指定时间（以秒为单位），在此时间之后，如果客户端未提供任何数据，clamd 应超时。默认值：120</translation>
    </message>
    <message>
        ...
        <translation>此选项指定时间（以秒为单位），在此时间之后，如果客户端在连接后未提供任何初始命令，clamd 应超时。默认设置为 30，以避免在处理大消息时 TCP 套接字超时。如果使用 Unix 套接字，该值可以更改为 5。注意：后续命令和/或数据块的超时由 ReadTimeout 指定。默认值：30</translation>
    </message>
    <message>
        ...
        <translation>此选项指定如果发送缓冲区已满，则等待多长时间（以毫秒为单位）。保持此值较低以防止 clamd 挂起。默认值：500</translation>
    </message>
    <message>
        ...
        <translation>队列项的最大数量（包括正在由 MaxThreads 线程处理的项）。建议在可能的情况下使此值至少为 MaxThreads 的两倍。警告：您不应增加太多，以避免耗尽文件描述符，应满足以下条件：MaxThreads*MaxRecursion + MaxQueue - MaxThreads + 6 &lt; RLIMIT_NOFILE。RLIMIT_NOFILE 是打开文件描述符的最大数量（通常为 1024），由 ulimit -n 设置。默认值：100</translation>
    </message>
    <message>
        <source>This option specifies how long (in seconds) the process should wait for a new job. Default: 30</source>
        <translation>此选项指定进程应等待新作业多长时间（以秒为单位）。默认值：30</translation>
    </message>
    <message>
        <source>Maximum depth directories are scanned at. Default: 15</source>
        <translation>扫描目录的最大深度。默认值：15</translation>
    </message>
    <message>
        <source>Follow directory symlinks. Default: no</source>
        <translation>跟随目录符号链接。默认值：no</translation>
    </message>
    <message>
        <source>Scan files and directories on other filesystems. Default: yes</source>
        <translation>扫描其他文件系统上的文件和目录。默认值：yes</translation>
    </message>
    <message>
        <source>Follow regular file symlinks. Default: no</source>
        <translation>跟随常规文件符号链接。默认值：no</translation>
    </message>
    <message>
        ...
        <translation>此选项指定 clamd 应执行数据库检查的时间间隔（以秒为单位）。默认值：600</translation>
    </message>
    <message>
        ...
        <translation>启用非阻塞（多线程/并发）数据库重新加载。此功能将暂时加载第二个扫描引擎，同时使用第一个引擎继续扫描。加载完成后，新引擎接管。一旦所有使用旧引擎的扫描完成，旧引擎将被移除。此功能需要更多 RAM，因此提供此选项，以便用户愿意在重新加载期间阻塞扫描以换取较低的 RAM 需求。默认值：yes</translation>
    </message>
    <message>
        ...
        <translation>在发现病毒时执行命令。使用以下环境变量来标识文件和病毒名称：- $CLAM_VIRUSEVENT_FILENAME - $CLAM_VIRUSEVENT_VIRUSNAME。在命令字符串中，&apos;%v&apos; 也将被替换为病毒名称。注意：由于命令注入的安全问题，&apos;%f&apos; 文件名格式字符已被禁用，将不再替换为文件名。请改用 &apos;CLAM_VIRUSEVENT_FILENAME&apos; 环境变量。出于同样的原因，您不应直接在命令中使用环境变量，而应从您执行的脚本中小心使用它们。默认值：禁用</translation>
    </message>
    <message>
        <source>Stop daemon when libclamav reports out of memory condition. Default: no</source>
        <translation>当 libclamav 报告内存不足情况时停止守护进程。默认值：no</translation>
    </message>
    <message>
        <source>Permit use of the ALLMATCHSCAN command. Default: yes</source>
        <translation>允许使用 ALLMATCHSCAN 命令。默认值：yes</translation>
    </message>
    <message>
        <source>Don&apos;t fork into background. Default: no</source>
        <translation>不要 fork 到后台。默认值：no</translation>
    </message>
    <message>
        <source>Enable debug messages from libclamav. Default: no</source>
        <translation>启用来自 libclamav 的调试信息。默认值：no</translation>
    </message>
    <message>
        <source>Do not remove temporary files (for debugging purpose). Default: no</source>
        <translation>不要移除临时文件（用于调试目的）。默认值：no</translation>
    </message>
    <message>
        ...
        <translation>记录有关正在扫描的文件的元数据。扫描元数据对于文件分析目的和调试扫描行为很有用。如果启用了 Debug，则扫描完成后将打印 JSON 元数据。如果启用了 LeaveTemporaryFiles，则会将 metadata.json 文件写入扫描临时目录。默认值：no</translation>
    </message>
    <message>
        ...
        <translation>将 html 文件中找到的 URI 存储到 json 元数据中。URI 将存储在一个带有 &apos;URIs&apos; 标签的数组中。此功能需要 GenerateMetadataJson。默认值：yes（如果使用了 GenerateMetadataJson）</translation>
    </message>
    <message>
        ...
        <translation>将 pdf 文件中找到的 URI 存储到 json 元数据中。URI 将存储在一个带有 &apos;URIs&apos; 标签的数组中。此功能需要 GenerateMetadataJson。默认值：yes（如果使用了 GenerateMetadataJson）</translation>
    </message>
    <message>
        ...
        <translation>计算 MD5 和 SHA1 哈希（除了 SHA2-256）并存储到 json 元数据中。此功能需要 GenerateMetadataJson。默认值：no</translation>
    </message>
    <message>
        <source>Run the daemon as a specified user (the process must be started by root). Default: disabled</source>
        <translation>以指定用户身份运行守护进程（该进程必须由 root 启动）。默认值：禁用</translation>
    </message>
    <message>
        ...
        <translation>启用此选项后，ClamAV 将从数据库加载字节码。强烈建议您保持此选项开启，否则您可能会错过许多新病毒的检测。默认值：yes</translation>
    </message>
    <message>
        ...
        <translation>设置字节码安全级别。可能的值：TrustSigned - 信任从签名的 .c[lv]d 文件加载的字节码，并为从其他来源加载的字节码插入运行时安全检查；Paranoid - 不信任任何字节码，为所有字节码插入运行时检查。推荐：TrustSigned，因为 .cvd 文件中的字节码已经具有这些检查。默认值：TrustSigned</translation>
    </message>
    <message>
        <source>Set bytecode timeout in milliseconds. Default: 10000</source>
        <translation>设置字节码超时时间（毫秒）。默认值：10000</translation>
    </message>
    <message>
        ...
        <translation>允许从数字签名的 .c[lv]d 文件之外加载字节码。**警告**：您绝不应该运行来自不可信来源的字节码签名。这样做可能导致任意代码执行。默认值：no</translation>
    </message>
    <message>
        ...
        <translation>设置字节码执行模式。可能的值：Auto - 自动选择 JIT（如果可能），否则回退到解释器；ForceJIT - 始终选择 JIT，如果不可能则失败；ForceInterpreter - 始终选择解释器；Test - 同时使用 JIT 和解释器运行并比较结果，使所有失败变为致命。默认值：Auto</translation>
    </message>
    <message>
        <source>Detect Possibly Unwanted Applications. Default: No</source>
        <translation>检测可能不需要的应用程序。默认值：No</translation>
    </message>
    <message>
        ...
        <translation>在某些情况下（例如复杂的恶意软件、图形文件中的漏洞利用等），ClamAV 使用特殊算法来提供准确的检测。此选项控制算法检测。默认值：yes</translation>
    </message>
    <message>
        ...
        <translation>允许启发式匹配优先。启用后，如果启发式扫描（例如网络钓鱼扫描）检测到可能的病毒/网络钓鱼，它将立即停止扫描。推荐，节省 CPU 扫描时间。禁用时，启发式扫描检测到的病毒/网络钓鱼仅在扫描结束时报告。如果存档同时包含启发式检测到的病毒/网络钓鱼和真实的恶意软件，则会报告真实的恶意软件。如果您打算将 &quot;*.Heuristics.*&quot; 病毒与&quot;真实&quot;恶意软件区别对待，请保持禁用状态。如果首先发现非启发式检测到的病毒（基于签名的），则无论此配置选项如何，都会立即中断扫描。默认值：no</translation>
    </message>
    <message>
        ...
        <translation>PE 代表可移植可执行文件 - 它是一种用于所有 32 位和 64 位 Windows 操作系统的可执行文件格式。此选项允许 ClamAV 对可执行文件执行更深入的分析，并且也是解压流行可执行文件加壳程序（如 UPX）所必需的。如果关闭此选项，仍将扫描原始文件，但不会进行额外处理。默认值：yes</translation>
    </message>
    <message>
        ...
        <translation>可执行和链接格式是 UN*X 可执行文件的标准格式。此选项允许您控制 ELF 文件的扫描。如果关闭此选项，仍将扫描原始文件，但不会进行额外处理。默认值：yes</translation>
    </message>
    <message>
        ...
        <translation>启用邮件文件扫描。如果关闭此选项，仍将扫描原始文件，但不会解析单个消息/附件。默认值：yes</translation>
    </message>
    <message>
        ...
        <translation>扫描拆分到多封电子邮件中的 RFC1341 消息。您需要定期清理 $TemporaryDirectory/clamav-partial 目录。警告：此选项可能会使您的系统遭受 DoS 攻击。切勿在负载较重的服务器上使用它。默认值：no</translation>
    </message>
    <message>
        <source>Enable email signature-based phishing detection. Default: yes</source>
        <translation>启用基于电子邮件签名的网络钓鱼检测。默认值：yes</translation>
    </message>
    <message>
        <source>Enable URL signature-based phishing detection (Heuristics.Phishing.Email.*) Default: yes</source>
        <translation>启用基于 URL 签名的网络钓鱼检测 (Heuristics.Phishing.Email.*)。默认值：yes</translation>
    </message>
    <message>
        <source>Enable the DLP module. Default: no</source>
        <translation>启用 DLP 模块。默认值：no</translation>
    </message>
    <message>
        <source>This option sets the lowest number of Credit Card numbers found in a file to generate a detect. Default: 3</source>
        <translation>此选项设置在文件中找到的信用卡号的最低数量，以生成检测。默认值：3</translation>
    </message>
    <message>
        ...
        <translation>启用此选项后，DLP 模块将仅搜索有效的信用卡号。不会搜索借记卡和自有品牌卡。默认值：No</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>执行 HTML/JavaScript/ScriptEncoder 规范化和解密。如果关闭此选项，仍将扫描原始文件，但不会进行额外处理。默认值：yes</translation>
    </message>
    <message>
        ...
        <translation>此选项启用 OLE2 文件的扫描，例如 Microsoft Office 文档和 .msi 文件。如果关闭此选项，仍将扫描原始文件，但不会进行额外处理。默认值：yes</translation>
    </message>
    <message>
        ...
        <translation>此选项启用在 PDF 文件内扫描。如果关闭此选项，仍将扫描原始文件，但不会进行额外处理。默认值：yes</translation>
    </message>
    <message>
        ...
        <translation>此选项启用在 SWF 文件内扫描。如果关闭此选项，仍将扫描原始文件，但不会进行解码和额外处理。默认值：yes</translation>
    </message>
    <message>
        ...
        <translation>此选项启用 libclamav 支持的基于 XML 的文档文件的扫描。如果关闭此选项，仍将扫描原始文件，但不会进行额外处理。默认值：yes</translation>
    </message>
    <message>
        ...
        <translation>此选项启用 HWP3 文件的扫描。如果关闭此选项，仍将扫描原始文件，但不会进行额外处理。默认值：yes</translation>
    </message>
    <message>
        ...
        <translation>此选项启用 OneNote 文件的扫描。如果关闭此选项，仍将扫描原始文件，但不会进行额外处理。默认值：yes</translation>
    </message>
    <message>
        ...
        <translation>在存档和压缩文件内扫描。如果关闭此选项，仍将扫描原始文件，但不会进行解包和额外处理。默认值：yes</translation>
    </message>
    <message>
        ...
        <translation>此选项启用图像扫描。如果关闭此选项，仍将扫描原始文件，但不会进行解包和额外处理。默认值：yes</translation>
    </message>
    <message>
        ...
        <translation>此选项通过计算图像文件的模糊哈希来启用检测。使用图像模糊哈希的签名通常通过识别嵌入或附加到这些文件的图像来匹配文件和文档。如果关闭此选项，则某些文件可能不再被检测到。默认值：yes</translation>
    </message>
    <message>
        <source>Alert on broken executable files (PE &amp; ELF). Default: no</source>
        <translation>对损坏的可执行文件（PE 和 ELF）发出警报。默认值：no</translation>
    </message>
    <message>
        <source>Alert on broken graphics files (JPEG, TIFF, PNG, GIF). Default: no</source>
        <translation>对损坏的图像文件（JPEG、TIFF、PNG、GIF）发出警报。默认值：no</translation>
    </message>
    <message>
        <source>Alert on encrypted archives and documents (encrypted .zip, .7zip, .rar, .pdf). Default: no</source>
        <translation>对加密的存档和文档（加密的 .zip、.7zip、.rar、.pdf）发出警报。默认值：no</translation>
    </message>
    <message>
        <source>Alert on encrypted archives (encrypted .zip, .7zip, .rar). Default: no</source>
        <translation>对加密的存档（加密的 .zip、.7zip、.rar）发出警报。默认值：no</translation>
    </message>
    <message>
        <source>Alert on encrypted documents (encrypted .pdf). Default: no</source>
        <translation>对加密的文档（加密的 .pdf）发出警报。默认值：no</translation>
    </message>
    <message>
        <source>Alert on OLE2 files containing VBA macros (Heuristics.OLE2.ContainsMacros). Default: no</source>
        <translation>对包含 VBA 宏的 OLE2 文件 (Heuristics.OLE2.ContainsMacros) 发出警报。默认值：no</translation>
    </message>
    <message>
        ...
        <translation>当设置了 AlertExceedsMax 时，超出 MaxFileSize、MaxScanSize 或 MaxRecursion 限制的文件将被标记为病毒名称以 &quot;Heuristics.Limits.Exceeded&quot; 开头。默认值：no</translation>
    </message>
    <message>
        <source>Alert on emails containing SSL mismatches in URLs (might lead to false positives!). Default: no</source>
        <translation>对包含 URL 中 SSL 不匹配的电子邮件发出警报（可能导致误报！）。默认值：no</translation>
    </message>
    <message>
        <source>Alert on emails containing cloaked URLs (might lead to some false positives). Default: no</source>
        <translation>对包含伪装 URL 的电子邮件发出警报（可能导致一些误报）。默认值：no</translation>
    </message>
    <message>
        <source>Alert on raw DMG image files containing partition intersections. Default: no</source>
        <translation>对包含分区交集的原始 DMG 镜像文件发出警报。默认值：no</translation>
    </message>
    <message>
        ...
        <translation>此选项允许您禁用引擎的缓存功能。默认情况下，引擎会将任何未被标记为病毒或触及限制检查的文件的 MD5 存储在缓存中。警告：禁用缓存将对大型扫描的性能产生负面影响。默认值：no</translation>
    </message>
    <message>
        ...
        <translation>此选项允许您设置缓存可以存储的条目数。该值应为平方数，否则将向上舍入到最接近的平方数。默认值：65536</translation>
    </message>
    <message>
        ...
        <translation>此选项导致内存或嵌套映射扫描将内容转储到磁盘。如果启用此选项，更多数据将写入磁盘，并在启用了 leave-temps 选项时可用，但代价是更多的磁盘写入。默认值：no</translation>
    </message>
    <message>
        ...
        <translation>此选项设置扫描完成所需的最长时间。该值以毫秒为单位。值为 0 表示禁用限制。警告：禁用此限制或将其设置过高可能导致扫描某些文件时锁定扫描进程/线程，从而导致拒绝服务。默认值：120000</translation>
    </message>
    <message>
        ...
        <translation>设置每个输入文件要扫描的最大数据量。存档和其他容器被递归提取并扫描，直到达到此值。存档的大小加上存档内所有文件大小的总和计入扫描大小。例如，一个包含单个 1M 内部文件的 1M 未压缩存档计为 2M 计入最大扫描大小。警告：禁用此限制或将其设置过高可能导致系统严重损坏。默认值：400M</translation>
    </message>
    <message>
        ...
        <translation>大于此限制的文件将不会被扫描。影响输入文件本身以及其中包含的文件（当输入文件是存档、文档或其他类型的容器时）。警告：禁用此限制或将其设置过高可能导致系统严重损坏。目前，技术设计限制阻止 ClamAV 扫描大于 2 GB 的文件。默认值：100M</translation>
    </message>
    <message>
        ...
        <translation>嵌套存档被递归扫描，例如，如果一个 Zip 存档包含一个 RAR 文件，其中的所有文件也将被扫描。此选项指定该过程应继续的深度。警告：将此限制设置过高可能导致系统严重损坏。默认值：17</translation>
    </message>
    <message>
        ...
        <translation>在存档、文档或任何其他类型的容器内要扫描的文件数量。警告：禁用此限制或将其设置过高可能导致系统严重损坏。默认值：10000</translation>
    </message>
    <message>
        ...
        <translation>此选项设置要检查嵌入式 PE 的文件的最大大小。大于此值的文件将跳过额外的分析步骤。不允许使用负值。默认值：40M</translation>
    </message>
    <message>
        ...
        <translation>此选项设置要规范化的 HTML 文件的最大大小。大于此值的 HTML 文件将不会被规范化或扫描。不允许使用负值。默认值：40M</translation>
    </message>
    <message>
        ...
        <translation>此选项设置要扫描的规范化 HTML 文件的最大大小。规范化后大于此值的 HTML 文件将不会被扫描。不允许使用负值。默认值：8M</translation>
    </message>
    <message>
        ...
        <translation>此选项设置要规范化的脚本文件的最大大小。大于此值的脚本内容将不会被规范化或扫描。不允许使用负值。默认值：20M</translation>
    </message>
    <message>
        ...
        <translation>此选项设置要重新分析类型识别的 ZIP 文件的最大大小。大于此值的 ZIP 文件将跳过可能重新分析为 PE 的步骤。不允许使用负值。警告：将此限制设置过高可能导致严重损坏或影响性能。默认值：1M</translation>
    </message>
    <message>
        ...
        <translation>此选项设置要扫描的原始磁盘镜像的最大分区数。分区数超过此值的原始磁盘镜像将扫描最多此值的分区数。不允许使用负值。警告：将此限制设置过高可能导致严重损坏或影响性能。默认值：50</translation>
    </message>
    <message>
        ...
        <translation>此选项设置要扫描的 PE 内图标的最大数量。图标数超过此值的 PE 文件将扫描最多此值的图标数。不允许使用负值。警告：将此限制设置过高可能导致严重损坏或影响性能。默认值：100</translation>
    </message>
    <message>
        ...
        <translation>此选项设置对 HWP3 解析函数的最大递归调用次数。使用超过此限制的 HWP3 文件将被终止并向用户发出警报。如果达到递归限制，扫描将无法扫描任何 HWP3 附件。不允许使用负值。警告：将此限制设置过高可能导致严重损坏或影响性能。默认值：16</translation>
    </message>
    <message>
        ...
        <translation>此选项设置正则表达式匹配实例中对 PCRE 匹配函数的最大调用次数。使用超过此限制的实例将被终止并向用户发出警报，但扫描将继续。有关 match_limit 的更多信息，请参阅 PCRE 文档。不允许使用负值。警告：将此限制设置过高可能会严重影响性能。默认值：10000</translation>
    </message>
    <message>
        ...
        <translation>此选项设置正则表达式匹配实例中对 PCRE 匹配函数的最大递归调用次数。使用超过此限制的实例将被终止并向用户发出警报，但扫描将继续。有关 match_limit_recursion 的更多信息，请参阅 PCRE 文档。不允许使用负值，且值大于 PCREMatchLimit 是多余的。警告：将此限制设置过高可能会严重影响性能。默认值：2000</translation>
    </message>
    <message>
        ...
        <translation>此选项设置将执行 PCRE 子签名的最大文件大小。超过此限制的文件将不会执行 PCRE 子签名，除非子签名被包含到较小的缓冲区中。不允许使用负值。将此值设置为零将禁用限制。警告：将此限制设置过高或禁用它可能会严重影响性能。默认值：100M</translation>
    </message>
    <message>
        ...
        <translation>使用此选项，您可以排除 root UID (0)。在 root 下运行的进程将能够访问所有文件，而不会触发扫描或权限被拒绝事件。请注意，如果 clamd 无法检查生成按访问扫描事件的进程的 uid（例如，因为未启用 OnAccessPrevention，并且进程已退出），clamd 将执行扫描。因此，设置 OnAccessExcludeRootUID 并不能保证阻止 root 用户的每次访问触发扫描（除非启用了 OnAccessPrevention）。默认值：no</translation>
    </message>
    <message>
        <source>Files larger than this value will not be scanned in on access. Default: 5M</source>
        <translation>大于此值的文件将不会被按访问扫描。默认值：5M</translation>
    </message>
    <message>
        ...
        <translation>启动时分配给 实时扫描 线程池的最大扫描线程数。这些线程负责与守护进程建立连接，并在事件处理后开始扫描。为防止 clamonacc 消耗所有 clamd 资源，请将此值保持低于 clamd 的最大线程数。默认值：5</translation>
    </message>
    <message>
        ...
        <translation>实时扫描 客户端在通过 curl 与 clamd 通信时，每次连接、发送和接收尝试应花费的最大时间量（以毫秒为单位）。默认值：5000（5 秒）</translation>
    </message>
    <message>
        ...
        <translation>指定一个挂载点（包括其下的所有文件和目录），应在访问时扫描。此选项可以多次使用。默认值：禁用</translation>
    </message>
    <message>
        ...
        <translation>禁用允许递归监视包含路径的动态目录确定系统。默认值：no</translation>
    </message>
    <message>
        <source>Enables fanotify blocking when malicious files are found. Default: disabled</source>
        <translation>在发现恶意文件时启用 fanotify 阻塞。默认值：禁用</translation>
    </message>
    <message>
        ...
        <translation>实时扫描 客户端由于连接问题（或其他问题）而重试失败扫描的次数。默认值：0</translation>
    </message>
    <message>
        ...
        <translation>当使用预防时，如果开启此选项，扫描期间发生的任何错误都将导致事件尝试被拒绝。在某些配置下，这可能导致不需要的系统行为，因此客户端默认关闭此选项，并在扫描或连接错误时倾向于允许访问事件。默认值：no</translation>
    </message>
    <message>
