...
<context>
    ...
    <message>
        ...
        <translation>Цей параметр визначає час (у секундах), після якого clamd має закінчитися, якщо клієнт не надає початкової команди після підключення. За замовчуванням встановлено значення 30, щоб уникнути тайм-аутів із TCP-сокетами під час обробки великих повідомлень. Якщо використовується сокет Unix, значення можна змінити на 5. Примітка: тайм-аут для наступних команд і/або фрагментів даних визначається параметром ReadTimeout. Типове значення: 30</translation>
    </message>
    <message>
